...
type
  ...
  public
    ...
    Rework,CheckVer,InputProcess,Upper,CheckSN : String;
...
begin
  ...
  begin
    ...
    Params.ParamByName('PRG').AsString := 'CM';
    Params.ParamByName('FUN').AsString := 'CM Config';
    Open;
...
begin
  ...
  begin
     ...
     TerminalID := ReadString('CM','Terminal','');
     cmbTypeID := ReadString('CM','TypeID','');
     Free;
  end;
end;
