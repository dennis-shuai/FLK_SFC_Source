...
begin
    ...
    qrytemp.CommandText:='SELECT SERIAL_NUMBER,CUSTOMER_SN FROM SAJET.G_SN_STATUS WHERE SERIAL_NUMBER=:SN or customer_SN =:SN ';
...
begin
    lbl2.Caption :=GetTerminalName(iTerminal);
end;
