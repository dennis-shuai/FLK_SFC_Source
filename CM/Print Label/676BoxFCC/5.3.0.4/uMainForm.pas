...
begin
   ...
   begin
        ...
        begin
          ...
          CommandText := 'Select serial_number,B.PART_NO,A.Customer_SN, '
                       + 'TO_CHAR( TO_NUMBER(SUBSTR(A.Serial_Number,7,6),'
                       + ' ''XXXXXX'')+1,''XXXXXX'' ) SSID  FROM SAJET.G_SN_STATUS A '
   ...
   begin
      ...
      begin
          ...
          begin
              try
                  BarDoc.Variables.Item('SN').Value := UpperCase( sCSN);
                  BarDoc.Variables.Item('MAC').Value := sSN;
        ...
        begin
            ...
            begin
               ...
               begin
                    ...
                    begin
                         try
                             BarDoc.Variables.Item('SN').Value :=  UpperCase(trim(sCSN));
                             BarDoc.Variables.Item('MAC').Value := sSN;
                             BarDoc.Variables.Item('SSID').Value := sSSID;
                             Bardoc.PrintLabel(1);
                             Bardoc.FormFeed;
