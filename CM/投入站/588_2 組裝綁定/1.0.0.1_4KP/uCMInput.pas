...
begin
   ...
   begin
       Close;
       DataRequest('SAJET.CCM_SN_4KP_ITEM_Input');
       FetchParams;
       ...
       Params.ParamByName('TITEM_PART_SN2').AsString := edtIR.Text;
       Params.ParamByName('TITEM_PART_SN3').AsString := edtRGB.Text;
...
begin
   ...
   iResult := CheckItemSN(edtIR.Text,'1');
...
begin
   ...
   iResult := CheckItemSN(edtRGB.Text,'2');
...
//
   ...
   ShowMSG('3D ¥DªO Label Input :',iResult,'');
   if iResult = 'OK' then
   begin
       edt3D.Enabled := False;
       edtIR.Enabled := True;
