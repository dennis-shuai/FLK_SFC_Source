...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, uCOBClearTray,
...
var sIniFile : String;
begin
  fCOBClearTray := TfCOBClearTray.Create(Self);
  With fCOBClearTray do
  begin
    Parent := Self;
    Align := alClient;
    BorderStyle := bsNone;
    ...
    begin
       //ReadString('Line-'+InttoStr(i),'Terminal_Id1','');
      iTraySNCount := ReadInteger('COB','TraySNCount',72);
