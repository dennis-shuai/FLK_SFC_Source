  ...
  begin
     ...
     begin
        ...
        CommandText := 'Select MODEL_ID '+
                       ...
                       'Where MODEL_NAME = :PART_NO ';
        Params.ParamByName('PART_NO').AsString := Trim(editPart.Text);
        Open ;
        if IsEmpty then
        begin
          S := 'Enter Error(Not Exist) !! '+#13#10 +
              'Model_Name : '+ editPart.Text + #13#10 +
              'Shift : '+ CmbShift.Text ;
          Close;
...
begin
  ...
  begin
    ...
    {CommandText := 'Select PART_NO, SPEC1, SPEC2, ' +
      ...
      'Order By PART_NO';}
    CommandText := 'Select MODEL_NAME ,MODEL_TYPE,MODEL_DESC1,MODEL_DESC2 ' +
                    'From SAJET.SYS_MODEL '+
                    ' WHERE MODEL_NAME LIKE :PN AND ENABLED = ''Y'' ORDER BY MODEL_NAME' ;
  ...
  begin
    ...
    begin
      editPart.Text := FormMain.QryTemp.Fieldbyname('MODEL_NAME').AsString;       //PART_NO
      editPart.SetFocus;
      GetModelName ;
    end;
    Free;
