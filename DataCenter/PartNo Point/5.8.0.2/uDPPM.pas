...
begin
  ...
  begin
    try
       ...
       Params.ParamByName('FUN').AsString :='Part Point Define';
       Execute;
...
begin
  ...
  begin
     ...
     CommandText := 'Insert Into SAJET.SYS_HT_PART_point '+
                      'Select * from SAJET.SYS_PART_point '+
...
begin
  ...
  begin
     ...
     editpartqty.Text :=QryData.Fieldbyname('part_QTY').aSString;
     editpointqty.Text :=QryData.Fieldbyname('POINT_QTY').aSString;
...
begin
  ...
  begin
    ...
    begin
      ...
      Params.Clear;
      Params.CreateParam(ftString	,'part_ID', ptInput);
      CommandText := 'Delete SAJET.SYS_PART_POINT '+
                     'Where part_ID = :part_ID ';
      Params.ParamByName('part_ID').AsString := QryData.Fieldbyname('part_ID').AsString;
      Execute;
      QryData.Delete;
