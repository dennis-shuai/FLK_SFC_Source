...
begin
  ...
  try
    ...
    begin
        MessageDlg('Defect Part Count values input Error!!'+#13#10,mtError, [mbCancel],0);
         editpartqty.SelectAll ;
         editpartqty.SetFocus ;
        exit;
    end;
  ...
  if strtoint( editpartqty.Text)<0 then
  begin
    MessageDlg('Defect part Count values input Error!!'+#13#10,mtError, [mbCancel],0);
    editpartqty.SelectAll;
    editpartqty.SetFocus;
     ...
     Try
        ...
        begin
           ...
           CommandText := 'Insert Into SAJET.SYS_part_point '+
                          ' (part_ID,part_qty,point_qty,UPDATE_USERID,update_time) '+
                          'Values (:part_ID,:part_qty,:point_qty,:UPDATE_USERID,sysdate) ';
           Params.ParamByName('part_ID').AsString := partID;
     ...
     Try
        ...
        begin
           ...
           CommandText := 'Update SAJET.SYS_part_point '+
                          'Set part_qty=:part_qty, point_qty=:point_qty, '+
