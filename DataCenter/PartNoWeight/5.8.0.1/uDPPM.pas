...
begin
  ...
  begin
    try
       ...
       Params.ParamByName('FUN').AsString :='Part Weight Define';
       Execute;
...
begin
  ...
  begin
     ...
     CommandText := 'Insert Into SAJET.SYS_HT_PART_WEIGHT '+
                      'Select * from SAJET.SYS_PART_WEIGHT '+
...
begin
  ...
  begin
     ...
     Editweightvalue.Text :=QryData.Fieldbyname('weight').aSString;
     Editerrorvalue.Text :=QryData.Fieldbyname('error').aSString;
...
begin
  ...
  begin
    ...
    begin
      ...
      Params.Clear;
      Params.CreateParam(ftString	,'part_ID', ptInput);
      CommandText := 'Delete SAJET.SYS_PART_WEIGHT '+
                     'Where part_ID = :part_ID ';
      Params.ParamByName('part_ID').AsString := QryData.Fieldbyname('part_ID').AsString;
      Execute;
      QryData.Delete;
