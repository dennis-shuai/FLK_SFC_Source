object fDetail: TfDetail
  ...
  object Panel1: TPanel
    ...
    object editASN: TEdit
      ...
      ImeName = 'Chinese (Simplified) - Microsoft Pinyin'
      TabOrder = 0
      OnKeyPress = editASNKeyPress
    end
    object sgCarton: TStringGrid
      Left = 288
      Top = 64
      Width = 257
      Height = 89
    ...
    object Editapplicationreceivercode: TEdit
      Left = 376
      Top = 8
      Width = 121
      Height = 21
  ...
  object QryCarton: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DspQryTemp1'
    Left = 576
