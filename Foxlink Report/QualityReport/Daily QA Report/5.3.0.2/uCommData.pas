...
begin
  if not fDetail.qryTemp.Active then
     Exit;
  if not fDetail.QryTemp.IsEmpty then
      fDetail.qryTemp.Locate(fDetail.qryTemp.Fields.Fields[0].FieldName, Trim(edtComm.Text), [loCaseInsensitive, loPartialKey])
end;
