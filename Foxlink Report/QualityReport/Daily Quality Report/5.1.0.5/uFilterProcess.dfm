object fFilterProcess: TfFilterProcess
  Left = 301
  Top = 137
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'fFilterProcess'
  ClientHeight = 427
  ClientWidth = 550
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SptnSave: TSpeedButton
      Left = 179
      Top = 392
      Width = 73
      Height = 18
      Flat = True
      OnClick = SptnSaveClick
    end
    ...
    object comSelect: TComboBox
      ...
      TabOrder = 1
      Text = 'Model Name'
      OnChange = comSelectChange
      Items.Strings = (
        'Model Name'
        'Part No')
    end
    object ChkListData: TTreeView
      Left = 43
      Top = 32
      Width = 462
      Height = 313
      ...
      ReadOnly = True
      TabOrder = 2
      OnMouseDown = ChkListDataMouseDown
    end
  end
end
