  ...
  begin
    try
      ...
      Try
        ...
        MsExcelWorkBook := MsExcel.WorkBooks.open(ExtractFilePath(Application.ExeName)+'MonthlyPQualityReport.xlt');
...
//*************寫入表頭的列值************ ********
 MsExcel.Worksheets['Sheet1'].range['A2'].value:=editmodel.Text+' Quality Monthly Report';
