      ...
      // repeat
          ...
          // Sleep(1000);
           ...
           begin
                ...
                begin
                    PLSN1.Caption :=  sn;
                    PLRT1.Caption :=  'SN 不能為空';
                    PLRT1.Color :=  clRed;
                    stat1.SimpleText :='SN 不能為空';
                    stat1.Color :=clRed;
                    Exit;
                end;
                ...
                begin
                    PLSN1.Caption :=  sn;
                    PLRT1.Caption :=  '測試結果不能為空';
                    PLRT1.Color :=  clRed;
                    stat1.SimpleText :='測試結果不能為空';
                    stat1.Color :=clRed;
                    Exit;
                end;
                ...
                if (sresult <>'PASS') and (sresult <>'FAIL') then begin
                    PLSN1.Caption :=  sn;
                    PLRT1.Caption :=  '不能識別測試結果:'+sresult;
                    PLRT1.Color :=  clRed;
                    stat1.SimpleText :='不能識別測試結果:'+sresult;
                    stat1.Color :=clRed;
                    Exit;
                end;
