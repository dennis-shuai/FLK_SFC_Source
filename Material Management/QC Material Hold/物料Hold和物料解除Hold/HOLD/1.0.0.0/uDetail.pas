...
begin
   ...
   begin
       ...
       Params.CreateParam(ftstring,'Material',ptinput);
       if (copy(edtMaterial.Text,1,1) ='Q') or (copy(edtMaterial.Text,1,1) = 'B') then begin
             commandtext := 'Insert into sajet.G_material_hold select * from sajet.g_Material where material_no =:Material';
       end else if copy(edtMaterial.Text,1,1) ='R'  then begin
              commandtext := 'Insert into sajet.G_material_hold select * from sajet.g_Material where Reel_no =:Material';
       end else  begin
            messageDlg('Error Material',mterror,[mbok],0);
            exit;
       end;
       ...
       Params.CreateParam(ftstring,'Material',ptinput);
       if (copy(edtMaterial.Text,1,1) ='Q') or (copy(edtMaterial.Text,1,1) = 'B') then begin
              commandtext := 'delete from sajet.g_Material where material_no =:Material';
       end else if copy(edtMaterial.Text,1,1) ='R'  then begin
              commandtext := 'delete from sajet.g_Material where Reel_no =:Material';
       end;
