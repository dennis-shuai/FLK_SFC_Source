...
begin
   ...
   begin
       ...
       params.Clear ;
       params.CreateParam(ftstring,'work_order',ptinput);
       commandtext:='select work_order,wo_status from sajet.g_wo_base where work_order=:work_order and rownum=1 ';
       params.ParamByName('work_order').AsString :=wo;
       open;
       if isempty then
       begin
  ...
  begin
    ...
    begin
      ...
      CommandText := 'insert into sajet.g_material '
        + '(part_id, datecode, material_no, material_qty, update_userid, warehouse_id, locate_id, update_time, status, REMARK, version,FIFOCode) '
        + 'values (:part_id, :datecode, :material_no, :material_qty, :update_userid, :warehouse_id, :locate_id, sysdate, 1,:REMARK, :version,:FIFO)';
      Params.ParamByName('PART_ID').AsString := sPartId;
