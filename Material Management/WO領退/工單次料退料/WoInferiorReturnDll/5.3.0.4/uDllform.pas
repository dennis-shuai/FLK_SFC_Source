...
begin
  ...
  begin                                            
    ...
    QryTemp1.ProviderName := 'DspQrydata1';
    QryWO.RemoteServer := G_sockConnection;
    QryWO.ProviderName := 'DspQrydata1';
    QryID.RemoteServer := G_sockConnection;
    QryID.ProviderName := 'DspQrydata1';
