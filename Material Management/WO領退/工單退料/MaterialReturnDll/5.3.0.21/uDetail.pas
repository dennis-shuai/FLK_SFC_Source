...
begin
  ...
  begin
    ...
    Params.Clear;
    Params.CreateParam(ftString, 'work_order', ptInput);
    CommandText := 'select work_order, WO_STATUS from sajet.g_wo_base '
  ...
  begin
    ...
    begin
      ...
      CommandText := 'insert into sajet.g_material '
        + '(part_id, datecode, material_no, material_qty, update_userid, warehouse_id, locate_id, update_time, status, MFGER_NAME, MFGER_PART_NO,RT_ID,REMARK, version,FIFOCode) '
        + 'values (:part_id, :datecode, :material_no, :material_qty, :update_userid, :warehouse_id, :locate_id, sysdate, 1, :MFGER_NAME, :MFGER_PART_NO,:RT_ID,:REMARK, :version,:FIFO)';
      Params.ParamByName('PART_ID').AsString := sPartId;
