        ...
        begin
           ...
           begin
            ...
            // sgMap.Cells[4,iRow]:=fieldbyname('MACHINE_CODE').AsString;
             ...
             sgMap.Cells[11,iRow]:=fieldbyname('datecode').AsString;
           //  sgMap.Cells[11,iRow]:=fieldbyname('qty').AsString;

             sgMap.Cells[12,iRow]:=fieldbyname('MFGER_NAME').AsString;
             sgMap.Cells[13,iRow]:=fieldbyname('MFGER_PART_NO').AsString;
             INC(IROW);
  ...
  begin
    ...
    BEGIN
     ...
     commandtext:=' select a1.work_order,decode(to_char(a1.side),''0'',''Top'',''1'',''Bottom'') side,b1.station_no,d1.part_no,f1.pdline_name,c1.datecode,TO_CHAR(c1.qty) QTY,g1.emp_name,To_CHAR(c1.in_time,''YYYY/MM/DD HH24:MI:SS'') IN_TIME,TO_CHAR(c1.item_part_id) flag '
      ...
      commandtext := commandtext
                +' Union '
                +' select a1.work_order,decode(to_char(a1.side),''0'',''Top'',''1'',''Bottom'') side,b1.station_no,d1.part_no,f1.pdline_name,c1.datecode,TO_CHAR(c1.qty) QTY,g1.emp_name,To_CHAR(c1.in_time,''YYYY/MM/DD HH24:MI:SS'') IN_TIME,TO_CHAR(c1.item_part_id) flag '
     ...
     begin
      ...
      begin
          ...
          begin
           ...
           sgOnline.Cells[14,iRow]:=fieldbyname('Is_sub_part').AsString;
           INC(IROW);
...
begin
  ...
  sgMap.Cells[11,0]:='datecode';

  sgMap.Cells[12,0]:='MFGER NAME';
  sgMap.Cells[13,0]:='MFGER PART NO';
