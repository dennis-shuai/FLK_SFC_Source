object fDetail: TfDetail
  ...
  object Panel1: TPanel
    ...
    object sbtntransfer: TSpeedButton
      Left = 250
      Top = 31
      Width = 21
      Height = 21
    ...
    object labmateriallocate: TLabel
      Left = 272
      Top = 250
      Width = 5
      Height = 16
    ...
    object edttransfer: TEdit
      ...
      Height = 21
      TabOrder = 1
      OnChange = edttransferChange
      OnKeyPress = edttransferKeyPress
    end
