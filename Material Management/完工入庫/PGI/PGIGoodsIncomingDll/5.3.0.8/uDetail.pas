        ...
        begin
           ...
           begin
              try
                  ...
                  Close;
                  //DataRequest('SAJET.KEY_WIP_INCOMING'); change by key 2009/1/16
                  DataRequest('SAJET.KEY_WIP_INCOMING2');
                  FetchParams;
                  ...
                  Params.ParamByName('TLOCATEID').AsString :=slLocateId[cmbLocate.ItemIndex];
                  Execute;
