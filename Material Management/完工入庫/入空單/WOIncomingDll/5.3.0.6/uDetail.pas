...
begin
  ...
  with QryTemp do begin
    ...
    CommandText := 'select target_qty, erp_qty, part_no from sajet.g_wo_base a, sajet.sys_part b '
...
begin
  ...
  begin
    ...
    begin
      ...
      Params.Clear;
      Params.CreateParam(ftString, 'wo', ptInput);
      CommandText := 'select a.target_qty,a.ERP_QTY,b.part_no,b.part_id from sajet.g_wo_base a,sajet.sys_part b  '
