...
//  sgData.Cells[2, 0] := 'Pallet/Lot';
  ...
  begin
    ...
    Params.ParamByName('dll_name').AsString := 'GOODSINCOMINGDLL.DLL';
    Open;
    ...
    begin
      ...
      begin
        ...
        CommandText := 'insert into sajet.g_material '
          + '(part_id, material_no, material_qty, update_userid, warehouse_id, locate_id, update_time, status, version,FIFOCode,FACTORY_ID,FACTORY_TYPE) '
          + 'values (:part_id, :material_no, :material_qty, :update_userid, :warehouse_id, :locate_id, sysdate, ''1'', :version,:FIFO,:FACTORY_ID,:FACTORY_TYPE)';
...
{        if sType <> '' then
      ...
      begin
        ...
        CommandText := 'insert into sajet.g_material '
          + '(part_id, material_no, material_qty, update_userid, warehouse_id, locate_id, update_time, status, version,FIFOCode,FACTORY_ID,FACTORY_TYPE) '
          + 'select model_id, carton_no, count(*), :update_userid, :warehouse_id, :locate_id, sysdate, 1, :version,:FIFO,:FACTORY_ID,:FACTORY_TYPE '
...
begin
  ...
  begin
    ...
    else if FieldByName('target_qty').AsInteger < FieldByName('erp_qty').AsInteger + sedtQty.Value then
    begin
