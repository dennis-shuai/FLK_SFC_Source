    ...
    begin
      try
        ...
        if f_sType = 'Pick List' then
          CommandText := 'select a.work_order,b.part_no,a.qty,to_char(a.update_time,''YYYY/MM/DD HH24:Mi:SS'') update_time,a.datecode,a.version,a.mfger_name,a.mfger_part_no '
            +' from sajet.g_pick_list a, sajet.sys_part b '
            + 'where a.part_id = b.part_id '
            + 'and material_no = :material_no and rownum = 1'
        else begin
          CommandText := 'select a.material_no,b.part_no,a.material_qty,a.reel_no,a.reel_qty,to_char(a.update_time,''YYYY/MM/DD HH24:Mi:SS'') update_time,c.rt_no,d.vendor_name '
