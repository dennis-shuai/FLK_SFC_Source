  ...
  begin
    ...
    begin
      ...
      CommandText := 'insert into sajet.g_material '
        + '(rt_id, part_id, datecode, material_no, material_qty,reel_no, reel_qty, update_userid, locate_id, warehouse_id, status, remark, RELEASE_QTY, VERSION, MFGER_NAME, MFGER_PART_NO,type,FIFOCode) '
        + 'select rt_id, part_id, datecode,material_no, material_qty, :reel_no, :reel_qty, :update_userid, locate_id, warehouse_id, status, remark, RELEASE_QTY, VERSION, MFGER_NAME, MFGER_PART_NO,:type,FIFOCOde '
    ...
    begin
      ...
      Params.CreateParam(ftString, 'material_no', ptInput);
      CommandText := 'insert into sajet.g_material '
        + '(rt_id, part_id, datecode, material_no, material_qty, update_userid, locate_id, warehouse_id, status, remark, RELEASE_QTY, VERSION, MFGER_NAME, MFGER_PART_NO,type,FIFOCode) '
        + 'select rt_id, part_id, datecode, :reel_no, :reel_qty, :update_userid, locate_id, warehouse_id, status, remark, RELEASE_QTY, VERSION, MFGER_NAME, MFGER_PART_NO,:type,FIFOCode '
