...
type
  ...
  public
    { Public declarations }
    UpdateUserID, gsType, gsLabelField,sRTID: string;
    sCnt: Integer;
...
begin
  ...
  begin
    ...
    Params.ParamByName('dll_name').AsString := 'MERGEDLL.DLL';
    Open;
...
begin
  ...
  begin
    ...
    begin
      ...
      CommandText := 'select distinct A.material_no,nvl(a.rt_id,0) rt_id, NVL(A.material_qty,0) material_qty,a.reel_qty, a.datecode, C.part_no, '
        + 'nvl(b.label_type, c.' + gsLabelField + ') label_type, a.status,d.warehouse_name, e.locate_name,a.warehouse_id,a.FIFOCode,a.type, a.factory_id,a.factory_type '
      ...
      begin
        ...
        Params.Clear;
        Params.CreateParam(ftString, 'material_no', ptInput);
        CommandText := 'select distinct a.reel_no material_no,nvl(a.rt_id,0) rt_id, a.reel_qty material_qty, a.datecode, c.part_no, a.Locate_id,'
          + '''Reel ID'' label_type, a.status ,d.warehouse_name, e.locate_name,a.warehouse_id ,a.FIFOCode ,a.type, a.factory_id,a.factory_type '
        ...
        else if fieldbyname('Locate_id').AsString='' then
        begin
            MessageDlg('Material Not Incoming.', mtError, [mbOK], 0);
            edtRT.SelectAll;
            edtRT.SetFocus;
        ...
        begin
          MessageDlg('Tansfer UnConfirm.', mtError, [mbOK], 0);
          edtRT.SelectAll;
          edtRT.SetFocus;
          Exit;
        end
      ...
      sRTID := FieldByName('rt_id').AsString;
      ...
      begin
        ...
        if sRTID <> edtRTID.Text then
        begin
          MessageDlg('RT ID [' + sRTID + '] [' + edtRTID.Text + '] different!', mtError, [mbOK], 0);
          edtRT.SelectAll;
          edtRT.SetFocus;
          Exit;
        end;
      ...
      sgData.Cells[10, sCnt + 1] := FieldByName('Rt_id').AsString;
...
var sPrintData, sStr, sStr1,sMinFIFO: string; i, J: Integer;
    Sfifo:tstrings;
begin
  ...
  //sgData.Cols[5].Names[]
  sFIFO:=sgData.Cols[7];
  sMinFIFO:=GetMinFIFOCode(sFIFO);
  //showmessage(sMinFIFO);
  with QryTemp do
  begin
...
//      + ' WAREHOUSE_ID=:Stock ,LOCATE_ID=:Locate,update_userid=:update_userid '
    ...
    Params.ParamByName('FIFO').AsString := sMinFIFO;
{    if cmbLocate.Text <> '' then
  ...
  sPrintData := G_getPrintData(6, 17, G_sockConnection, 'DspQryData', gsType + '*&*' + sgData.Cells[1, 1], 1, '');
