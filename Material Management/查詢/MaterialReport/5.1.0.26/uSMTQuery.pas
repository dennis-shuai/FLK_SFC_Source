...
begin
  ...
  begin
    close;
    params.Clear;
    commandtext:=' select SUBSTR(wo_sequence,3,length(wo_sequence)) work_order,g.pdline_name,b.stage_name,c.process_name,d.part_no,a.datecode,f.vendor_name,a.qty,to_char(in_time,''YYYY/MM/DD HH:MI:ss'') in_time '
 ...
 begin
   ...
   begin
     ...
     begin
      ...
      params.CreateParam(ftString	,'iReel', ptInput);
      commandtext:=' select a.wo_sequence,b.pdline_name,c.part_no,d.emp_name,to_char(a.in_time,''yyyy/mm/dd hh24:mi:ss'') in_time '
                            +' ,to_char(a.out_time,''yyyy/mm/dd hh:mi:ss'') out_time,a.station_no,a.feeder_no,a.reel_no,e.vendor_name,a.datecode,a.MFGER_NAME,a.MFGER_PART_NO   '
