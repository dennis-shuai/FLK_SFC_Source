...
begin
  ...
  begin
    close;
    params.Clear;
    commandtext:=' select SUBSTR(wo_sequence,3,length(wo_sequence)) work_order,g.pdline_name,b.stage_name,c.process_name,d.part_no,a.reel_no,a.datecode,f.vendor_name,a.qty,to_char(in_time,''YYYY/MM/DD HH:MI:ss'') in_time '
    ...
    begin
      ...
      begin
        ...
        sgDIP.Cells[6,iRow]:= fieldbyname('reel_no').AsString;
 ...
 begin
  ...
  begin
    ...
    commandtext:=' select a.wo_sequence,b.pdline_name,c.part_no,d.emp_name,to_char(a.in_time,''yyyy/mm/dd hh24:mi:ss'') in_time '
                            +' ,a.feeder_no,a.reel_no,a.reel_qty,e.vendor_name,a.datecode,a.MFGER_NAME,a.MFGER_PART_NO   '
 ...
 begin
   ...
   begin
     ...
     begin
      ...
      params.CreateParam(ftString	,'iReel', ptInput);
      commandtext:=' select a.wo_sequence,b.pdline_name,c.part_no,d.emp_name,to_char(a.in_time,''yyyy/mm/dd hh24:mi:ss'') in_time '
                            +' ,to_char(a.out_time,''yyyy/mm/dd hh:mi:ss'') out_time,a.station_no,a.feeder_no,a.reel_no,a.reel_qty,e.vendor_name,a.datecode,a.MFGER_NAME,a.MFGER_PART_NO   '
...
begin
  ...
  begin
    ...
    begin
      ...
      commandtext:=' select  b1.work_order,d1.part_no,g1.pdline_name,a1.datecode,nvl(e1.vendor_code,e1.vendor_name) vendor,nvl(f1.emp_name,f1.emp_no) emp,a1.in_time ,a1.out_time,round((a1.out_time-a1.in_time)*24*60,2) subtime '
                  +'               ,a1.reel_no,a1.reel_qty,a1.MFGER_NAME,a1.MFGER_PART_NO  '
      ...
      commandtext:=commandtext
                 +' union '
                 +'  select  b2.work_order,d2.part_no,g2.pdline_name,a2.datecode,nvl(e2.vendor_code,e2.vendor_name) vendor,nvl(f2.emp_name,f2.emp_no) emp,a2.in_time ,a2.out_time,round((sysdate-a2.in_time)*24*60,2)  subtime  '
                 +'               ,a2.reel_no,a2.reel_qty,a2.MFGER_NAME,a2.MFGER_PART_NO  '
...
begin
  ...
  sgDIP.Cells[6,0]:='Reel NO';
  sgDIP.Cells[7,0]:='DATECODE/Lot Code';
