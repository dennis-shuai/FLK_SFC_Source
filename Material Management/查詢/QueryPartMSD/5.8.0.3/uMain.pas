...
BEGIN
   ...
   stringgrid1.Cells[2,0]:='MSL';
   stringgrid1.Cells[3,0]:='Line name' ;
   stringgrid1.Cells[4,0]:='Machine' ;
   stringgrid1.Cells[5,0]:='Part no' ;
   stringgrid1.Cells[6,0]:='Reel no';
   stringgrid1.Cells[7,0]:='Start time' ;
   stringgrid1.Cells[8,0]:='Floor life(H)';
   stringgrid1.Cells[9,0]:='Open time(M)' ;
   stringgrid1.Cells[10,0]:='Feeder no' ;
   stringgrid1.Cells[11,0]:='Station no' ;
...
begin
   ...
   strsql:=' select e.work_order,A.wo_sequence,d.pdline_name,f.machine_code,b.part_no,a.reel_no,   '
   ...
   with Qrydata do
      ...
      while not eof do
       begin
          ...
          stringgrid1.Cells[2,irow]:= fieldbyname('wo_sequence').AsString ;
          stringgrid1.Cells[3,irow]:=fieldbyname('pdline_name').AsString ;
          stringgrid1.Cells[4,irow]:= fieldbyname('machine_code').AsString ;
          stringgrid1.Cells[5,irow]:=fieldbyname('part_no').AsString;
          stringgrid1.Cells[6,irow]:=fieldbyname('reel_no').AsString;
          stringgrid1.Cells[7,irow]:=fieldbyname('in_time').AsString ;
          stringgrid1.Cells[8,irow]:= fieldbyname('floor_life').AsString ;
          stringgrid1.Cells[9,irow]:=fieldbyname('open_time').AsString ;
          stringgrid1.Cells[10,irow]:= fieldbyname('feeder_no').AsString ;
          stringgrid1.Cells[11,irow]:=fieldbyname('station_no').AsString;
          inc(irow);
          next;
       end;
       if irow<=5 then
