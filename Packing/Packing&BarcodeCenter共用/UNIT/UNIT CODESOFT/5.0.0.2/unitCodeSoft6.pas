...
begin
  ...
  try
    ...
    m_tsParameter.Clear;
    for i:=1 to m_CS6.ActiveDocument.Variables.FormVariables.Count do  m_tsParameter.Add(m_CS6.ActiveDocument.Variables.FormVariables.item(i).Name);
...
begin
  ...
  try
    ...
    for i:=1 to m_tsParameter.Count do begin
      ...
      if iIndex>=0 then m_CS6.ActiveDocument.Variables.FormVariables.Item(i).Value:=m_PrintData.m_tsData[iIndex];
    end;
  finally
    tsParameter.free;
  end;
