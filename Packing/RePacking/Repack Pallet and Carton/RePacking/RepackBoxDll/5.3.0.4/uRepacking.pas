...
begin
   ...
   if ((lablfifocode.Caption<>'0' ) or ((lablfifocode.Caption='0' )and qrycartondata.IsEmpty ))
     and (editReBoxNo.Text<>soldcarton ) then
      with qrymaterial do
        begin
           ...
           commandtext:='select material_no from sajet.g_material '
                      +' where material_no= ''' +  editReBoxNo.Text + ''' and rownum=1 ';
           open;
           if isempty then
              begin
                 close;
                 ...
                 commandtext:=' insert into sajet.g_material  '
                          ...
                          +' SELECT part_id,''' +  editReBoxNo.Text + ''',''1'',status,locate_id,warehouse_id,'''+UpdateUserID+''',SYSDATE,version,type,fifocode,factory_id,factory_type '
                 ...
                 commandtext:='insert into sajet.g_ht_material '
                        +' (select * from sajet.g_material where material_no= ''' + editReBoxNo.Text + ''' and rownum=1 )';
                 execute;
