object fRepacking: TfRepacking
  ...
  object Panel1: TPanel
    ...
    object sbtnNewPallet: TSpeedButton
      Left = 418
      Top = 64
      Width = 23
      Height = 22
    ...
    object editRePalletNO: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = editRePalletNOChange
      OnKeyPress = editRePalletNOKeyPress
    end
    object editCartonNo: TEdit
      Left = 127
      Top = 64
      Width = 284
      Height = 24
      ...
      ParentFont = False
      TabOrder = 1
      OnKeyPress = editCartonNoKeyPress
    end
    object lvCarton: TListView
      Left = 17
      Top = 124
      Width = 209
      Height = 358
      ...
      TabOrder = 2
      ViewStyle = vsReport
      OnClick = lvCartonClick
    end
    object lvCSN: TListView
      Left = 237
      Top = 124
      Width = 465
      Height = 358
  ...
  object QryPalletData: TClientDataSet
    Aggregates = <>
    Params = <>
