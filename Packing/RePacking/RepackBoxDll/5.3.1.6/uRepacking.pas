...
type
  ...
  public
    ...
    g_sn:string;
    IsBoxInStock,IsCSNInStock,IsInRepackTemp:Boolean;
   ...
   end;
   {
    ...
    begin
          ...
          begin
                ...
                if not IsInRepackTemp then begin
    ...
    begin
        if IsCSNInstock then lablfifocode.Caption:= qrymaterial.fieldbyname('fifocode').AsString ;
         ...
         if (not IsCSNInStock) and  (not IsInRepackTemp) then begin
            if mWoOfBox <> mWoOfCSN then
            begin
