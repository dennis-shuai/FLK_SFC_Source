...
type
  ...
  public
    { Public declarations }
    UpdateUserID : String;
    TerminalID,cmbTypeID : String;
    UpdateSetdata : Boolean;
    FcID : String;
    Authoritys,AuthorityRole : String;
    Rework,CheckVer,InputProcess,Upper,CheckSN,Checkpartno : String;
...
begin
  ...
  begin
    ...
    Params.ParamByName('PRG').AsString := 'Preventing';
...
Function TfData.LoadApServer : Boolean;
Var F : TextFile;
    S : String;
begin
{  Result := False;
...
begin
  ...
  begin
     ...
     TerminalID := ReadString('Preventing','Terminal','');
     cmbTypeID := ReadString('Preventing','TypeID','');
     Free;
  end;
end;
...
begin
  ...
  begin
  {
     Rework := ReadString('ASSY','Rework','');
     CheckVer := ReadString('ASSY','CheckVer','');
     Checkpartno:=ReadString('ASSY','Checkpartno','');
     InputProcess := ReadString('ASSY','InputProcess','');
     Upper := ReadString('ASSY','Upper','');
     CheckSN := ReadString('ASSY','CheckSN','');
     Free;
  }
  end;
end;
...
begin
  ...
  fStation.Show;
  fStation.sbtnSave.Enabled := ((Authoritys = 'Allow To Change') or (AuthorityRole = 'Allow To Change'));
  fStation.Label3.Enabled := ((Authoritys = 'Allow To Change') or (AuthorityRole = 'Allow To Change'));
end;
