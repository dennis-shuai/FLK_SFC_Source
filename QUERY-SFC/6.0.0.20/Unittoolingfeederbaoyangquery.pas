unit Unittoolingfeederbaoyangquery;
...
type
  TFormfeederbaoyangquery = class(TForm)
    Label1: TLabel;
    Label7: TLabel;
...
var
  Formfeederbaoyangquery: TFormfeederbaoyangquery;
  var icol,irow:integer;
  var strTstart,strtend:string;
...
procedure TFormfeederbaoyangquery.WriteLog(sTrLog:string);
var vFile: Textfile;
...
procedure TFormfeederbaoyangquery.cleardata;
begin
...
procedure TFormfeederbaoyangquery.getdata;
begin
   strTstart:='';
   strtend:=''  ;
...
procedure TFormfeederbaoyangquery.queryfeeder(strTstart,strtend: string);
              ...
              BEGIN
                 if fieldbyname('status').asstring='M' then
                    begin
                      ...
                      stringgridfeeder.Cells[6,irow]:='30' ;
                      stringgridfeeder.Cells[7,irow]:=copy(floattostr(30*100 / strtoint(stringgridfeeder.Cells[5,irow])),0,6);
...
procedure TFormfeederbaoyangquery.btncloseClick(Sender: TObject);
begin
   close;
end;

procedure TFormfeederbaoyangquery.FormShow(Sender: TObject);
begin
...
procedure TFormfeederbaoyangquery.btnqueryClick(Sender: TObject);
begin
    GETDATA;
...
procedure TFormfeederbaoyangquery.BtnsaveClick(Sender: TObject);
