...
procedure TfSelectItem.sbtnOKClick(Sender: TObject);
begin
  modalresult := mrOK;
end;

procedure TfSelectItem.sbtnCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfSelectItem.IncludeBtnClick(Sender: TObject);
var
  index,i: Integer;
  sModelGroup:string;
begin
...
procedure TfSelectItem.IncAllBtnClick(Sender: TObject);
var
  index,i: Integer;
  sModelGroup:string;
begin
...
procedure TfSelectItem.ExcludeBtnClick(Sender: TObject);
var
  index: Integer;
begin
...
procedure TfSelectItem.ExAllBtnClick(Sender: TObject);
var I: Integer;
begin
   if listbSel.Items.Count <> 0 then begin
...
procedure TfSelectItem.MoveSelected(List: TCustomListBox; Items: TStrings);
var
   I: Integer;
begin
...
procedure TfSelectItem.SetItem(List: TListBox; Index: Integer);
var
   MaxIndex: Integer;
begin
   with List do
...
function TfSelectItem.GetFirstSelection(List: TCustomListBox): Integer;
begin
