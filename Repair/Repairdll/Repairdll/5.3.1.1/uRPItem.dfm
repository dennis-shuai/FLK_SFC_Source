object formRPItem: TformRPItem
  ...
  object sbtnVenFilter: TSpeedButton
    Left = 346
    Top = 114
    Width = 23
    Height = 22
    ...
    ParentShowHint = False
    ShowHint = True
    OnClick = sbtnVenFilterClick
  end
  object LabVendor: TLabel
    Left = 185
    Top = 143
    Width = 52
    Height = 18
  ...
  object editDateCode: TEdit
    ...
    ParentFont = False
    TabOrder = 2
    OnKeyPress = editDateCodeKeyPress
  end
