...
begin
  try
    if fDllReworkbyPiece<>nil then begin
      fDllReworkbyPiece.free;
      fDllReworkbyPiece:=nil;
    end;
  except
...
begin
  try
    CloseSajetDll;
    fDllReworkbyPiece := TfDllReworkbyPiece.Create(nil);
    With fDllReworkbyPiece do
    begin
