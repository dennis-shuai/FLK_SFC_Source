object formMain: TformMain
  ...
  object Panel1: TPanel
    ...
    object labTitleB: TLabel
      ...
      Width = 199
      Height = 16
      Caption = 'Material Station List Maintain'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object sbtnPreview: TSpeedButton
      Left = 273
      Top = 35
      Width = 73
      Height = 17
    ...
    object lablDetail: TLabel
      Left = 10
      Top = 263
      Width = 107
      Height = 13
      Caption = 'Material List Detail'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clRed
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object cstrGridWo1: TColorStringGrid
      Left = 10
      Top = 280
      Width = 587
      Height = 249
      ...
      ParentFont = False
      TabOrder = 1
      OnDblClick = cstrGridWo1DblClick
      OnSelectCell = cstrGridWo1SelectCell
      ColWidths = (
        56
        93
        57
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'Wo_Sequence'
          Title.Alignment = taCenter
          Title.Caption = 'Wo Sequence'
          Title.Font.Charset = DEFAULT_CHARSET
          Title.Font.Color = clWindowText
          Title.Font.Height = -11
          Title.Font.Name = 'MS Sans Serif'
  ...
  object dsrcData: TDataSource
    DataSet = QryData
    OnDataChange = dsrcDataDataChange
    Left = 96
    Top = 160
  end
