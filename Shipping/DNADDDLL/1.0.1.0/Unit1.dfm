object Form1: TForm1
  ...
  object pnl1: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 102
      Height = 18
      Caption = #37559#21806#21934#34399' (SO):'
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Arial Black'
    ...
    object lbl6: TLabel
      ...
      Width = 211
      Height = 16
      Caption = 'Version: 1.0.0.0  (20130808)'
    ...
    object sbtnUpdate: TSpeedButton
      Left = 187
      Top = 470
      Width = 75
      Height = 18
    ...
    object edtDN: TRzEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = edtDNChange
      OnKeyPress = edtDNKeyPress
    end
    object edtSO: TRzEdit
      Left = 179
      Top = 389
      Width = 241
      Height = 28
      ...
      Font.Name = 'MS Sans Serif'
      Font.Style = [fsBold]
      FocusColor = clCaptionText
      ImeName = #20013#25991' (?'#20307') - '#25628#29399#25340#38899'?'#20837#27861
      ParentFont = False
      TabOrder = 1
      OnKeyPress = edtSOKeyPress
    end
    object edtCust: TRzEdit
      Left = 178
      Top = 434
      Width = 241
      Height = 28
