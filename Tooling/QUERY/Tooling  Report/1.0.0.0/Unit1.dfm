    ...
    object DBGrid11: TDBGrid1
      ...
      Columns = <
        item
          ...
          Title.Color = clInactiveCaptionText
          Width = 100
          Visible = True
        end
        item
          Alignment = taCenter
          Expanded = False
          FieldName = 'Machine_Used'
          Title.Alignment = taCenter
          Title.Caption = #26159#21542#20351#29992
          Title.Color = clInactiveCaptionText
          Width = 80
          Visible = True
        end
        ...
        item
          ...
          FieldName = 'EMP_NAME'
          Title.Alignment = taCenter
          Title.Caption = #30435#31649#20154
          Title.Color = clInactiveCaptionText
          Width = 80
          Visible = True
        end
