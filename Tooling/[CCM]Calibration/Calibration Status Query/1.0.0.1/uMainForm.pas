...
begin
    ...
    begin
        ...
        ExcelApp.ActiveSheet.Range['A1:O1'].Columns.AutoFit;
...
begin
    ...
    begin
       try
          ...
          if (rest_hour < 0)  or  ( sresult = 'Fail' )  then
          begin
                DBGrid1.Canvas.Brush.Color:=clRed;
                DBGrid1.DefaultDrawColumnCell(Rect,DataCol,Column,State);
          end
          else if  (sresult ='PASS') and  (sEndTIme <> '' ) and (rest_hour <= Waring_Hour ) and ( rest_hour > 0) then
          begin
                DBGrid1.Canvas.Brush.Color:=clYellow;
                DBGrid1.DefaultDrawColumnCell(Rect,DataCol,Column,State);
          end  else if (sresult ='PASS') and  (sEndTIme <> '' ) and (rest_hour > Waring_Hour ) then
          begin
