object fMain: TfMain
  ...
  object Panel1: TPanel
    ...
    object LabTitle2: TLabel
      ...
      Width = 199
      Height = 16
      Caption = 'Tooling Change Used Status'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object SBTNUpdateToUsed: TSpeedButton
      Left = 480
      Top = 64
      Width = 113
      Height = 18
      Cursor = crHandPoint
      Caption = 'Update To Used'
      Flat = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
    ...
    object sbtnupdatetounused: TSpeedButton
      Left = 608
      Top = 64
      Width = 113
      Height = 18
      Cursor = crHandPoint
      Caption = 'Update To Unsed'
      Flat = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      ...
      Font.Style = [fsBold]
      ParentFont = False
      OnClick = sbtnupdatetounusedClick
    end
    object CMBBOXTYPE: TComboBox
      Left = 384
      Top = 32
      Width = 145
      Height = 21
    ...
    object cmbboxusedstatus: TComboBox
      Left = 872
      Top = 32
      Width = 97
      Height = 21
      ...
      TabOrder = 5
      Visible = False
      OnChange = cmbboxusedstatusChange
      Items.Strings = (
        'Y:'#20351#29992#20013
        'N:'#38750#20351#29992)
    end
