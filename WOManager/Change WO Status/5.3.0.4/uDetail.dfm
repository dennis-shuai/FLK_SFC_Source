object fDetail: TfDetail
  ...
  object Panel1: TPanel
    ...
    object SBTCONFIRM: TSpeedButton
      Left = 166
      Top = 373
      Width = 75
      Height = 18
      ...
      Font.Style = [fsBold]
      ParentFont = False
      OnClick = SBTCONFIRMClick
    end
    object lablReel: TLabel
      Left = 248
      Top = 128
      Width = 5
      Height = 16
    ...
    object Labeltargetqty: TLabel
      ...
      ParentFont = False
      Transparent = True
      OnDblClick = LabeltargetqtyDblClick
    end
    ...
    object Imagenewtargetqty: TImage
      Left = 446
      Top = 109
      Width = 75
      Height = 18
    ...
    object sbtnchangetargetqty: TSpeedButton
      Left = 446
      Top = 109
      Width = 75
      Height = 18
      ...
      ParentFont = False
      Visible = False
      OnClick = sbtnchangetargetqtyClick
    end
    object ImageNewInputQty: TImage
      Left = 446
      Top = 149
      Width = 75
      Height = 18
    ...
    object btnchangeInputqty: TSpeedButton
      Left = 446
      Top = 149
      Width = 75
      Height = 18
      ...
      ParentFont = False
      Visible = False
      OnClick = btnchangeInputqtyClick
    end
    object EditWO: TEdit
      Left = 144
      Top = 48
      ...
      OnKeyDown = EditWOKeyDown
    end
    object EditWORULE: TEdit
      Left = 144
      Top = 80
      Width = 161
      Height = 21
    ...
    object Cmbboxwostatus: TComboBox
      Left = 320
      Top = 240
      Width = 193
      Height = 21
