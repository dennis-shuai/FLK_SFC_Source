   ...
   sProcess :=Copy(sProcess,1, length(sProcess)-1);
    ...
    if Count > 0 then begin
      ...
      for i:=0 to uMainForm.QryData.RecordCount-1 do begin
          ...
          if  row =1 then  begin
               sDefectCode1.Add(uMainForm.QryData.fieldbyname('DEFECT_DESC').AsString) ;
               ...
               sDateTime1.Add(uMainForm.QryData.fieldbyname('DATETIME').AsString) ;
                ...
                sDefectCode2.Add(uMainForm.QryData.fieldbyname('DEFECT_DESC').AsString) ;
                ...
                sDefectCode3.Add(uMainForm.QryData.fieldbyname('DEFECT_DESC').AsString) ;
...
begin
    ...
    QryTemp.CommandText := ' SELECT  '+sTemp+' DATETIME,WORK_TIME '+
                            ...
                            ' ROUND(NVL(SUM(PASS_QTY),0)/NVL(SUM(PASS_QTY+FAIL_QTY),0)*100,2)  as "SPY" '+
                            ' from (  '+
                            ...
                            ' and b.PROCESS_COde <=e.PROCESS_Code  and a.PDLINE_ID =d.PDLINE_ID  and (a.PASS_QTY+a.FAIL_QTY) <>0 ) '+
